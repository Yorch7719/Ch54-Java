...
<<<<<<< HEAD
		 * String message;
		 * 
		 * VariableﾠcamelCaseﾠnombreUsuario
		 * MétodoﾠcamelCaseﾠcalcularSueldo()
		 * ClaseﾠPascalCaseﾠEmpleado, FacturaVenta
		 * ConstanteﾠUPPER_SNAKE_CASEﾠMAX_TAMANIO, PI_VALOR
		 * Paqueteﾠlowercase (a veces con puntos)ﾠcom.miempresa.utils
=======
		 *         String message;
>>>>>>> upstream/main
		 * 
...
<<<<<<< HEAD
		int myVarEnEspañol; // es válida, se recomienda en Inglés.
		int sinC0m3nt4r10s; // es válida, es confusa
		int val; // es válidam, pero muy genérica
		boolean hasPaymentBeenProcessed; // válida y recomendada
		String cfn; // válida, dificil de comprender
         ...
         *  
         *  usos: util para ahorrar memoria cuando los valores numéricos son pequeños 
         */
		System.out.println("Max value in byte type: " + Byte.MAX_VALUE); // 127
		System.out.println("Max value in byte type: " + Byte.MIN_VALUE); // -128
		 ...
		 * 
		 * usos: util para ahorrar memoria cuando los valores numericos
		 * 		son pequeños. Sistemas embebidos con memoria limitada
		 * */
		
		System.out.println("Max value in bit type: " + Short.MAX_VALUE); // 32767
		System.out.println("Max value in bit type: " + Short.MIN_VALUE); // -32768
=======
...
<<<<<<< HEAD
		 ...
		 * 
		 * usos: Adecuado para la mayoria de los números: Contadores, índices de arreglos,
		 * 		 cantidad de productos en inventario. 
		 * 
		 * Obtener el rango máximo y minimo del tipo int.
		 */
		
		System.out.println("Max value in data int type: " + Integer.MAX_VALUE); // 2147483647
		System.out.println("Max value in data int type: " + Integer.MIN_VALUE); // -2147483648
		 ...
		 * 
		 * usos: IDs de transacciones bancarias, marcas de tiempo precisas, IDs
		 * 		 en grandes bases de datos
		 */
		
		System.out.println("Max value in data long type: " + Long.MAX_VALUE); // 9223372036854775807
		System.out.println("Max value in data long type: " + Long.MIN_VALUE); // -9223372036854775808
		
		/*
		 * Las literales numéricas enteras en java son de tipo int
		 * ej. 12, -456, 0
		 * Para indicar una literal numerica de tipo long
		 * hay que indicar la literal con la letra l o L.
		 * Se recomienda usar la L para no confundir con el 1
		 * 
		 * Se puede utilizar _ para una mayor legibilidad en un valor 
		 * numéricos.
		 */
		...
		/*
		 * Dato de tipo float
		 * Dato de 32 bits, almacena valor numérico de punto flotante.
		 * 
		 * el wrapper de float es Float.
		 * 
		 * usos: La precisión no necesita ser extremadamente alta.
		 * 
		 * nota: tanto float como double tiene pérdida de presición
		 * Para evitar la pérdida de precisión se puede usar la clase BigDecimal
		 */
		System.out.println("Max value in data float type: " + Float.MAX_VALUE); // 3.4028235E38
		System.out.println("Max value in data float type: " + Float.MIN_VALUE); // 1.4E-45
		
		System.out.println( .1 + .2 ); // 0.30000000000000004
		
		/*
		 * Dato de tipo double
		 * Dato de 64 bits, almacena valores numéricos de punto flotante
		 * 
		 * El wrapper de double es Double
		 * 
		 * usos: Se elige double para cálculos que requieran alta exactitud como cálculos científicos. 
		 * 		 También para coordenadas geográficas. 
		 * 
		 *  nota: Para cálculos financieros críticos, la clase BigDecimal es más recomendada.
		 */
		...
		float productRatingAvegage = 4.7F;
...
<<<<<<< HEAD
		 * Solo almacena caracteres de la tabla unicode(16bits)
		 * puede almacenar del 0 al 65535
		 */
		
		// Tienes una tienda de ropa que maneja las tallas S, M, L
		...
		// Asignar la letra X usando unicode
		productSizeCode = '\u0058';
		System.out.println("Talla: " + productSizeCode ); // X		
		// Asignar la letra X usando valor numérico
		productSizeCode = 88;
		System.out.println("Talla: " + productSizeCode ); // X
=======
...
<<<<<<< HEAD
		...
		/*
		 * 01010100 01101000 01100101 00100000 01110100 01101001 01101101 
		 *     T      h         e    (espacio) 
		 */
