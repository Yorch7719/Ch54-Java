...
<<<<<<< HEAD
         ...
         * 
         * Los bucles se usan para ejecutar un bocle de código repetidamente mientras
         * se cumpla una condicción. Son fundamentales para tareas como recorrer arrays, 
         * procesar colecciones de datos o simplemente repetir una acción 
=======
		 * Sintaxis:
		 * 
		 * for( expresion_inicial ; comparacion; expresion_final) instrucción;
...
<<<<<<< HEAD
        ...
        for (;;) {
        	if (iteracion > 5)
        		break;
        	System.out.println("Num. Iteración: " + iteracion++); // 1-4
        }
        
        System.out.println("Valor final de iteracion: " + iteracion); // 5 
        
        // ---------------------------------
        /*
         * Una label (etiqueta) en Java es un identificador que le poners a un 
         * bucle para poder controlarlo desde adentro de otro bucle anidado
         * 
         * Su uso principal es con las sentancias break y continue para 
         * especificar a cuál bucle es una serie de bucles anidados queres 
         * afectar. 
         * Sin una etiqueta, break o continues suempre se aplican al bucle mas interno.
         */
        ...
        // Tabal de multiplicación del 1 al 10
        principal: 
        	for (int i = 1; i <= 5; i++) {
